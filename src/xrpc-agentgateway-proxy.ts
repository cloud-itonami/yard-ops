...
// ../cljs/src/yard_ops/app.kotoba); backend TypeScript was to be left alone. It
...
// with a different verb surface) is a product decision this migration does
// not make. It is recorded here, unmodified, so the next reader does not
